...
export const DataTable = ({ schedule, currency, emi }) => {
  ...
  return (
    <Box sx={{ mx: { xs: 2, sm: 4, md: 20 }, color: theme.palette.primary.main }}>
      ...
      <Box
        sx={{ display: "flex", justifyContent: "space-between", my: "4dvh" }}
      >
        <SelectCurrency />
            ...
            {schedule.map((data) => (
              <TableRow key={data.month}>
                ...
                <TableCell align="center">
                  {data.principal.toFixed(2)} {currency}
                </TableCell>
                <TableCell align="center">
                  {data.interest.toFixed(2)} {currency}
                </TableCell>
                <TableCell align="center">
